...
//
    public class IntSegmentedTuple
    {
        ...
        private void allocateMoreSpace()
        {
            ...
            {
                base_size *= 2;
                Array.Copy(base_buf, 0, base_buf = new int[base_size][], 0, k);
            }

            base_buf[k] = new int[1 << log_blksize];
        ...
        {
            return base_buf[i >> log_blksize][i % (1 << log_blksize)];
        }
        ...
        {
            this.base_buf = new int[this.base_size][];
        }
